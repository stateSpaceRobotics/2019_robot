...
class PFieldNavigator(object):
    ...
    def __init__(self):
        ...
        self.miniBot_poses4 = PoseArray()
        self.miniBot_poses5 = PoseArray()
        ...
        self.miniBot_poses4.poses.append(Pose())
        self.miniBot_poses5.poses.append(Pose())
        ...
        self.miniBot_poses4_pub = rospy.Publisher("/robot_4/miniBot_poses", PoseArray, queue_size = 10)
        self.miniBot_poses5_pub = rospy.Publisher("/robot_5/miniBot_poses", PoseArray, queue_size = 10)
        ...
        rospy.Subscriber("/robot_4/odom", Odometry, self.stage_robot4_callback)
        rospy.Subscriber("/robot_5/odom", Odometry, self.stage_robot5_callback)
    ...
    def stage_robot0_callback(self, data):
        ...
        self.miniBot_poses4.poses[0] = newPose
        self.miniBot_poses5.poses[0] = newPose
    ...
    def stage_robot1_callback(self, data):
        ...
        self.miniBot_poses4.poses[1] = newPose
        self.miniBot_poses5.poses[1] = newPose
    ...
    def stage_robot2_callback(self, data):
        ...
        self.miniBot_poses4.poses[2] = newPose
        self.miniBot_poses5.poses[2] = newPose
    ...
    def stage_robot3_callback(self, data):
        ...
        self.miniBot_poses4.poses[3] = newPose
        self.miniBot_poses5.poses[3] = newPose
        self.miniBot_poses3_pub.publish(self.miniBot_poses3)

    def stage_robot4_callback(self, data):
        '''
        Callback for robot_4/odom
        '''
        newPose = data.pose.pose #since odom has pose with covariance you need to get out first
        self.miniBot_poses0.poses[3] = newPose
        self.miniBot_poses1.poses[3] = newPose
        self.miniBot_poses2.poses[3] = newPose
        self.miniBot_poses3.poses[3] = newPose
        self.miniBot_poses5.poses[4] = newPose
        self.miniBot_poses4_pub.publish(self.miniBot_poses4)

    def stage_robot5_callback(self, data):
        '''
        Callback for robot_5/odom
        '''
        newPose = data.pose.pose #since odom has pose with covariance you need to get out first
        self.miniBot_poses0.poses[4] = newPose
        self.miniBot_poses1.poses[4] = newPose
        self.miniBot_poses2.poses[4] = newPose
        self.miniBot_poses3.poses[4] = newPose
        self.miniBot_poses4.poses[4] = newPose
        self.miniBot_poses5_pub.publish(self.miniBot_poses5)
